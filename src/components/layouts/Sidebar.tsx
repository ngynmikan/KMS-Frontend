...
const menuItems = [
  ...
  { icon: ClipboardList, label: 'Tuyển sinh', path: '/registrations' },
  { icon: Calendar, label: 'Lịch học', path: '/schedule' },
  { icon: ImageIcon, label: 'Hoạt động', path: '/activities' },
  ...
  { icon: Star, label: 'Đánh giá', path: '/evaluations' },
  { icon: Stethoscope, label: 'Sổ sức khỏe', path: '/health-records' },
